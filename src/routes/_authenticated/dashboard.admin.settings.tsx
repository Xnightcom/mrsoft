      ...
      <div className="max-w-4xl space-y-6">
        <div>
          ...
          <p className="text-white/50 text-sm mt-1">
            Platform-wide rules, security policies, and user configuration.
          </p>
        </div>
          ...
          <CardContent className="p-6 md:p-8 space-y-6">
            <div className="flex items-start gap-4">
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm text-white/60">
                  User accounts are categorized into Admin, Student, and Client levels. Roles are
                  mapped to the <code>profiles.role</code> database column and enforce dynamic
                  layout views.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 border-t border-white/5 pt-6">
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm text-white/60">
                  All databases are protected by Supabase RLS. Students can query their own
                  attendance, assignments, and certificates. Clients access invoices and projects
                  related to their profile ID. Admins bypass these conditions.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 border-t border-white/5 pt-6">
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm text-white/60 text-justify">
                  Platform configurations (SMTP settings, Vercel pipelines, domain configuration)
                  are managed via system environment variables. Inquiries and client project updates
                  sync in real-time.
                </p>
              </div>
            </div>
