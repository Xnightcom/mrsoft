...
function InstructorAttendance() {
  ...
  return (
    <div style={{ padding: 24 }}>
      ...
      >
        {[
          ...
          >
            ...
            <p style={{ color: s.color, fontSize: 32, fontWeight: 700 }}>{s.value}</p>
          </div>
        ))}
      </div>
            ...
            return (
              <div
                ...
                style={{
                  ...
                  padding: "14px 20px",
                  borderBottom:
                    i < students.length - 1 ? "1px solid rgba(255,255,255,0.05)" : "none",
              ...
              >
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                  ...
                  <span style={{ color: "white" }}>{s.profiles?.full_name ?? "Unknown"}</span>
                </div>
      ...
      >
        {saving ? "Saving..." : saveSuccess ? "✓ Attendance Saved!" : "Save Attendance"}
      </button>
    </div>
  );
}
