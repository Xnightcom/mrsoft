...
export default function AdminAnnouncements() {
  ...
  const [form, setForm] = useState({
    title: "",
    body: "",
    target_roles: ["admin", "instructor", "student", "client"],
    is_pinned: false,
    expires_at: "",
  });
      ...
      <div style={{ padding: 24 }}>
        ...
        {loading ? (
          ...
          >
            ...
            <p style={{ fontSize: 18, marginTop: 12 }}>No announcements yet</p>
            <p style={{ fontSize: 14, marginTop: 8 }}>Click "New Announcement" to post one</p>
          </div>
        ) : (
          <div
            style={{
            ...
            <div style={{ display: "flex", justifyContent: "end", gap: 12, marginTop: 8 }}>
              ...
              <button
                ...
                style={{
                  ...
                  fontSize: 13,
                  opacity:
                    saving || !form.title || !form.body || form.target_roles.length === 0 ? 0.6 : 1,
                }}
              >
