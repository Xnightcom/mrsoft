  ...
  head: () => ({
    meta: [
      { title: "Contact — MRsoft Digital Hub" },
      {
        name: "description",
        content:
          "Get in touch with M-R International. Request a demo, a quote, or talk to our team.",
      },
    ],
  }),
...
function ContactPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white text-[#060606]">
      ...
      <section
        className="relative overflow-hidden py-20 md:py-24 text-center text-[#060606]"
        style={{ borderBottom: "1px solid rgba(26,107,26,0.3)" }}
      >
        <div className="container relative mx-auto px-4" style={{ zIndex: 5 }}>
          <h1 className="text-4xl md:text-5xl font-bold heading-accent-center-red heading-slide-in text-[#060606]">
            Let's build together
          </h1>
          <p className="mt-6 text-lg text-neutral-600 max-w-2xl mx-auto reveal-fade-up">
            ...
            <div key={c.title} className="reveal-fade-up">
              <div className="tilt-card-light relative overflow-hidden rounded-xl">
                <CardContent className="p-6 flex items-start gap-4">
                  <div
                    className="grid h-10 w-10 place-items-center rounded-lg bg-[#1A6B1A]/10 text-[#1A6B1A] border"
          ...
          <CardContent className="p-8">
            ...
            >
                  ...
                  <SelectContent className="bg-white border-neutral-200 text-[#060606]">
                    {[
                      ...
                      <SelectItem
                        key={s}
                        value={s}
                        className="focus:bg-[#CC0000] focus:text-white cursor-pointer"
                      >
                        {s}
                      </SelectItem>
                    ))}
              ...
              <div className="sm:col-span-2">
                <Label htmlFor="desc" className="text-neutral-700">
                  Project description
                </Label>
                <Textarea
                  id="desc"
              ...
              <div className="sm:col-span-2">
                <Button
                  ...
                  className="ripple-btn w-full sm:w-auto btn-primary-gradient"
