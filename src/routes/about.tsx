    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="relative overflow-hidden py-20 md:py-28 text-center text-white" style={{ borderBottom: "1px solid rgba(26,107,26,0.3)" }}>
        <div className="container relative mx-auto px-4" style={{ zIndex: 5 }}>
          <h1 className="text-4xl md:text-5xl font-bold heading-accent-center-green heading-slide-in">About MRsoft</h1>
          <p className="mt-6 text-lg text-white/70 max-w-2xl mx-auto reveal-fade-up">A team of engineers, trainers, and consultants building the digital backbone of modern organizations.</p>
        </div>
      </section>
