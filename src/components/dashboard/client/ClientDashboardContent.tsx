            ...
            {activeProjects.length > 0 ? (
              activeProjects.map((project) => {
                ...
                const completedMilestones =
                  project.milestones?.filter((m: any) => m.is_completed).length || 0;
                const progress =
                  totalMilestones === 0
                    ? 0
                ...
                return (
                  <div
                    key={project.id}
                    className="bg-[#0F0F0F] border border-[#1a6b1a]/30 rounded-xl p-6 hover:border-[#CC0000]/50 transition-colors group"
                  >
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div className="shrink-0 text-sm text-white/50 flex flex-col items-end">
                        <span className="flex items-center gap-1">
                          <CheckCircle2 size={14} className="text-[#1A6B1A]" />{" "}
              ...
              <div className="bg-[#0F0F0F] border border-[#1a6b1a]/20 rounded-xl p-12 flex flex-col items-center justify-center text-center">
                ...
                <p className="text-white/50 max-w-sm mb-6">
                  You don't have any active projects right now. Ready to start something new?
                </p>
                <Link to="/contact" className="text-[#CC0000] font-medium hover:underline">
